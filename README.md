...
Additional information and optional commands are detailed in the "Detailed Instructions" section below.
...
A full compilation output example is provided in the appendix.
...
The analysis generates and saves plots described in the results section.
...
make clean Example Output

$ make clean
Cleaning files...
./src/Event_cxx.d
./src/Point_cxx.d
./src/Trajectory_cxx.d
./src/HitPoint_cxx.d
...
Done.
...
Processing /home/user/project/src/Event.cxx+...
Info in <TUnixSystem::ACLiC>: creating shared library /home/user/project/src/Event_cxx.so
...
Done.
